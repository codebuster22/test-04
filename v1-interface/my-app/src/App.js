                ...
                <div className="text-white px-4 py-10 sm:px-0 w-full">
                  ...
                  <div className="py-4">
                    <div className="flex col-2">
                      ...
                      <div className="space-x-reverse">626.42 wETH</div>
                    </div>
                    ...
                    <br></br>
                    <div className="flex col-2">
                      <div className=" text-lg mr-auto">Max Vault Capacity</div>
                      <div className="flex">5,000.00 wETH</div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-row rounded-xl m-auto w-2/3 h-7/8 my-0 items-center gap-y-16 gap-x-8 mx-10 my-12 sm:px-6 sm:py-20 items-center justify-center">
                <Tabs className="text-white content-center place-content-center justify-self-center bg-gray-900 border-4 border-cyan-400 backdrop-opacity-70 bg-blend-soft-light rounded-md w-full h-full">
                  ...
                  <Tabs.TabPane
                    ...
                    key="withdraw"
                  >
                    <div className=" text-white d-flex flex-column p-4 w-100 content-center justify-center">
                      <div>
            ...
            <div className="mx-auto px-40 md:grid-col-2 flex flex-row px-14">
              <div className="mx-auto w-screen h-screen max-w-7xl py-20">
                ...
                <p className="mt-4 text-gray-500">
                  The vault earns yield on its wETH deposits by running a weekly
                  automated wETH covered call strategy where it stakes its wETH
                  deposits in and then uses its to collateralize weekly
                  out-of-money wETH call options. The yield earned from both the
                  covered call strategy and the wETH staking rewards are
                  reinvested weekly, effectively compounding the yields for
